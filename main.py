...
class BoxApp(App):
    ...
    def __init__(self, **kwargs):
        ...
        self.textinput_1 = TextInput(text=str(date.today()), font_size=50)
        self.textinput = TextInput(text='NAME', font_size=50)
    ...
    def image_zoom(self, instance):
        ...
        for filename in os.listdir(image_dir_path):
            ...
            btPlus = GridLayout(cols=2, spacing=1, size_hint_y=None, height=80)

            self.button2 = TextInput(text='0', font_size=50, multiline=False)
            ...
            self.label = Button(text=filename[:-4], on_press=self.add_number, font_size=50,
                                background_color=(1.0, 0.0, 0.0, 1.0))
            self.label.k = self.button2
            button4 = Button(text='X', font_size=50, background_color=(1.0, 0.0, 0.0, 1.0))
            button4.bind(on_press=modal.dismiss)
            button4.id = filename

            self.button5 = Button(text='+1', on_press=add_one_product, font_size=50)
            self.button5.instance = self.label
            self.button5.k = self.button2
            btPlus.add_widget(self.button5)

            self.button6 = Button(text='-1', on_press=reduce_one_product, font_size=50)
            self.button6.instance = self.label
            self.button6.k = self.button2
            btPlus.add_widget(self.button6)

            bl.add_widget(btPlus)
        ...
        if self.filename in os.listdir(download_dir_path):
            with open(download_dir_path + self.filename, "r") as xt_js_file:
                ...
                for j in self.bs:
                    if f < len(a):
                        if j == a[f]['kod']:
                            self.bs[j].text = str(a[f]['quantity'])
                            print(a[f])
                        else:
    ...
    def build(self):
        btn = Button(text='File', on_press=self.load,font_size=50)
        carousel = Carousel()
        ...
        textButton = Button(text='OK', on_press=self.add_file, font_size=50)
        self.sumLabel = Label(text='Hello world', font_size=50)
        # to_excel = Button(text='ToExcel', on_press=self.convert_to_excel, font_size=20)
        partnerListButton = Button(text='List', on_press=self.list_partners, font_size=50)
        file.add_widget(partnerListButton)
        ...
        glImg = GridLayout(cols=1, spacing=1, size_hint_y=None, height=980)
        ...
        for filename in os.listdir(image_dir_path):
            ...
            bl = GridLayout(cols=6, spacing=1, size_hint_y=None, height=130)
            btPlus = GridLayout(cols=2, spacing=1, size_hint_y=None, height=130)
            ...
            rl = RelativeLayout(size_hint_y=None, height=830)
            button4 = Button(text='Zoom', on_press=self.image_zoom, font_size=50, 
                                background_color=(1.0, 1.0, 1.0, 25.0))
            button4.id = filename
            ...
            bl.add_widget(button4)
            layout = GridLayout(cols=1, spacing=1, size_hint_y=None, height=830)
